...
export function checkAllValues({name, price, description, image}) { 
...
export async function checkAllValuesUser({name, lastName, image, email, password, role}){ 
    ...
    if(!role) throw new Error("Role missing to save the user")
